...
<section class="container py-3">
    ...
    <div class="row align-items-center px-4 mt-3">
        ...
        <div class="col-md-7 col-lg-8" >
            <form id="formAgregarJugador" action="${pageContext.request.contextPath}/app?accion=update&id=${jugadorAEditar.id}"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="mail" name="mail" value="${jugadorAEditar.mail}" required>
                    </div>
                    <div class="col-sm-6 mb-3">
                        <label for="fechaNac" class="form-label">Fecha de nacimiento</label>
                        <input type="date" class="form-control" id="fechaNac" name="fechaNac" value="${jugadorAEditar.fechaNacimiento}" required>
                    </div>
